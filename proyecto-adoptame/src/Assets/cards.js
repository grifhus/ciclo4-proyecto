const adopta = [
  ...
  },
  {
    ...
    nombre: "Icaro",
    observacion:
      "Es un gatico cachorro encontrado en la calle. Ya esta vacunado",
  ...
  },
  {
    ...
    nombre: "Oreo",
    observacion:
      "Hoy en día se encuentra dispuesto a encontrar un hogar amoroso y responsable que quiera darle una segunda oportunidad.",
  ...
  },
  {
    ...
    nombre: "Nica",
    observacion:
      "Rescatada a las afueras de Bogotá, en desnutrición y con heridas en todo su cuerpo. Se recupero y hoy e día esta dispuesta a encontrar un hogar que le de todo el amor que se merece.",
  ...
  },
  {
    ...
    nombre: "Selina",
    observacion:
      "Tamaño pequeña, activa, sociable con otros gatos, aun tiene desconfianza con las personas debido a maltrato   ",
  ...
  },
  {
    ...
    nombre: "Toby",
    observacion:
      "Fue rescatado en Pereira con una neumonía severa, logró recuperarse luego de varios meses. Él está buscando un hogar amoroso y responsable que lo ame para toda la vida.",
    rasgos: "Tiene el pelo cafe  , ademas tiene una patica mala",
  ...
  },
  {
    ...
    nombre: "Bootstrap",
    observacion:
      "Fue rescatada de la calle,  no sabemos cuanto tiempo llevaba recorriendo las calles de Pereira, pero estaba muy agotada detrás de las personas en busca de comida. Su cara pedía ayuda. Fue rescatada y trasladada a la veterinaria, donde se atendió y alimentó.",
  ...
  },
  {
    ...
    nombre: "CSS",
    observacion:
      "Ha llegado al mejor momento de todos! El momento de buscar un gran hogar.",
  ...
  },
  {
    ...
    nombre: "Node",
    observacion:
      "Ella es de tamaño, mediano/grande es muy sociable, comparte muy bien con otros perros y es muy tierna.",
  ...
  },
  {
    ...
    nombre: "Toby",
    observacion:
      "Es de temperamento noble,  tamaño grande, está esterilizada,  muy amigable, tierna y sociable. ",
  ...
  },
  {
    ...
    nombre: "Petra",
    observacion:
      "Su tamaño mediano, es muy tranquila, cariñosa  y alegre. Socializa muy bien con otros perros.",
